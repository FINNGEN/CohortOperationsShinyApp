...
RUN Rscript -e 'remotes::install_version("shinyjqui",upgrade="never", version = "0.4.0")'
...
RUN Rscript -e 'remotes::install_version("FinnGenTableTypes",upgrade="never", version = "0.0.0.9000")'
...
RUN Rscript -e 'remotes::install_version("DatabaseConnector",upgrade="never", version = "4.0.2")'
RUN Rscript -e 'remotes::install_version("CDMTools",upgrade="never", version = "0.0.0.9004")'
RUN Rscript -e 'remotes::install_version("bigrquery",upgrade="never", version = "1.4.0")'
RUN Rscript -e 'remotes::install_github("dreamRs/toastui@7d822033c756ef7d4f4c9f7029bc7b476408c664")'
...
EXPOSE 80
CMD R -e "options('shiny.port'=80,shiny.host='0.0.0.0');CohortOperationsShinyApp::run_app()"
